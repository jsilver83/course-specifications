...
. If a decision is made to develop the remaining parts of the Adaa locally after completing this system, it is expected that several human resources will be occupied by the project for long periods of time. 
...
* Banner 3rd party module

.Justification

Any one of the two can provide the requested functionality. However, more time is needed to make a final decision.
