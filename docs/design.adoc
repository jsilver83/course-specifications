= Software Design Document for Course Specification
...
| 1.0     | Ali Aljowaher  <ali.aljowaher@kfupm.edu.sa> |  2019-03-27 | First version
|==================================================
...
The document contains the proposed the data model for the CRF2. Course Specifications form.

=== Scope

The transformation of the Course Specifications written form into a digital form with automation of the corresponding and related
fields .
